...
export default function MyLoyalty({navigation}) {
  ...
  return (
    <View style={{flex: 1}}>
      <ScrollView>
        ...
        <LoyalPoint />
        <QrCard titile1="Enjoy exclusive offers and dicounts at merchant outlets" titile2="More information" image={qrData[0].img} />
